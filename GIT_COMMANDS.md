# SALTA v0.4.15 – Git and Release Commands
...
Pushing `v0.4.15` starts `.github/workflows/release.yml` and publishes the multi-architecture container images.

Expected tags:

```text
ghcr.io/syschelle/salta:0.4.15
...
Run this command from the directory containing `SALTA-v0.4.15.zip`:
...
```bash
git show v0.4.15 --no-patch
git ls-remote --tags origin refs/tags/v0.4.15
gh release view v0.4.15
```
