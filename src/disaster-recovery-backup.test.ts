...
vi.mock("./configuration-backup.js", () => ({
  createConfigurationBackup: vi.fn(async (version: string, signingKey: string) => ({
    ...
    data: {
      ...
      device_adapter_data: [], automations: [{ id: "automation-1" }], automation_preferences: [], automation_time_triggers: [], automation_triggers: [], automation_actions: [], automation_targets: [],
