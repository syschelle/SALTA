...
`v0.4.21` is the current stable release. It makes device cards more compact and prevents short cards from stretching to the height of larger cover controls.
...
```text
ghcr.io/<github-owner>/<repository>:0.4.21
