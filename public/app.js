let all=[],rooms=[],systemLogs=[],selectedDevice=null,shellySettingsStatus=null,phosconSettingsStatus=null,hueSettingsStatus=null,openCcuSettingsStatus=null,presenceData=null,climateModeData=null,vacationModeData=null,notificationData=null,generalData=null,appearanceData=null,homeKitData=null,editingPresenceTargetId=null,editingRoomId=null,liveRefreshInFlight=false,activeCoverSliderId=null,activeBrightnessSliderId=null,activeTemperatureSliderId=null,activeHueColorTemperatureId=null,activeHueColorId=null,presenceSettingsDirty=false,selectedRecoveryBackup=null,csrfToken="";
const appI18n=globalThis.SaltaI18n;
function appLocale(){return appI18n?.locale?.()||'de-DE'}
function appTranslate(value){return appI18n?.translateSource?.(value)??String(value)}
...
const APPEARANCE_COLOR_FIELDS=[
  ['background','Seitenhintergrund','--bg'],['card','Karten','--card'],['text','Text','--text'],['muted','Sekundärtext','--muted'],['line','Linien / Rahmen','--line'],['accent','Akzent','--accent'],['success','Erfolg / Online','--green'],['buttonBackground','Primäre Buttons','--button-bg'],['buttonText','Button-Text','--button-text'],['inputBackground','Eingabefelder','--input-bg'],['sidebarBackground','Sidebar','--sidebar-bg'],['subtleBackground','Dezente Flächen','--subtle-bg'],['accentBackground','Akzentflächen','--accent-bg'],['hoverBackground','Hover-Flächen','--hover-bg'],['dialogTabsBackground','Dialog-Flächen','--dialog-tabs-bg'],['emptyBackground','Leere Bereiche','--empty-bg'],['toastBackground','Hinweis-Hintergrund','--toast-bg'],['toastText','Hinweis-Text','--toast-text'],['roomBackground','Raumabgrenzung','--overview-room-bg'],['stateOnBackground','Gerät AN · Fläche','--state-on-bg'],['stateOnBorder','Gerät AN · Rahmen','--state-on-border'],['stateOnAccent','Gerät AN · Akzent','--state-on-accent'],['stateOnIconBackground','Gerät AN · Icon','--state-on-icon-bg'],['stateOffBackground','Gerät AUS · Fläche','--state-off-bg'],['stateOffBorder','Gerät AUS · Rahmen','--state-off-border'],['stateOffAccent','Gerät AUS · Akzent','--state-off-accent'],['stateOffIconBackground','Gerät AUS · Icon','--state-off-icon-bg']
];
const APPEARANCE_STANDARD={
 light:{background:'#f4f6f8',card:'#ffffff',text:'#17202a',muted:'#77808b',line:'#e6e9ed',accent:'#2457e6',success:'#20a66a',buttonBackground:'#17202a',buttonText:'#ffffff',inputBackground:'#ffffff',sidebarBackground:'#ffffff',subtleBackground:'#f7f8fa',accentBackground:'#eef2ff',hoverBackground:'#f5f7fb',dialogTabsBackground:'#fafbfc',emptyBackground:'#ffffff',toastBackground:'#17202a',toastText:'#ffffff',roomBackground:'#eef2ff',stateOnBackground:'#effaf4',stateOnBorder:'#dbe8e0',stateOnAccent:'#16865a',stateOnIconBackground:'#dff3e8',stateOffBackground:'#fff3f4',stateOffBorder:'#eddfe2',stateOffAccent:'#c53a49',stateOffIconBackground:'#fbe0e3'},
 dark:{background:'#0d1117',card:'#151b23',text:'#edf2f7',muted:'#98a4b3',line:'#2a3441',accent:'#7aa2ff',success:'#35c98a',buttonBackground:'#7aa2ff',buttonText:'#0b1220',inputBackground:'#10161e',sidebarBackground:'#111821',subtleBackground:'#111821',accentBackground:'#1b2942',hoverBackground:'#1a222d',dialogTabsBackground:'#111821',emptyBackground:'#151b23',toastBackground:'#273241',toastText:'#f7f9fc',roomBackground:'#1b2942',stateOnBackground:'#13271f',stateOnBorder:'#2b3b33',stateOnAccent:'#55d49a',stateOnIconBackground:'#1b3a2d',stateOffBackground:'#2d191d',stateOffBorder:'#413136',stateOffAccent:'#ff8290',stateOffIconBackground:'#482229'}
};
function appearancePreset(lightOverrides={},darkOverrides={}){return {light:{...APPEARANCE_STANDARD.light,...lightOverrides},dark:{...APPEARANCE_STANDARD.dark,...darkOverrides}}}
const APPEARANCE_PROFILES={
 standard:appearancePreset(),
 ocean:appearancePreset({background:'#f2f7fc',accent:'#0b6fe8',accentBackground:'#e7f1ff',hoverBackground:'#edf5ff',roomBackground:'#e7f1ff',buttonBackground:'#123b66',success:'#15916a'},{background:'#08131e',card:'#0f1d2a',sidebarBackground:'#0b1723',subtleBackground:'#0b1723',inputBackground:'#0a1621',line:'#23394d',accent:'#62a8ff',accentBackground:'#122d49',hoverBackground:'#14263a',roomBackground:'#122d49',buttonBackground:'#62a8ff'}),
 forest:appearancePreset({background:'#f3f8f4',accent:'#2f7d55',accentBackground:'#e7f3eb',hoverBackground:'#edf7f0',roomBackground:'#e7f3eb',buttonBackground:'#244f3a',success:'#2f9d67'},{background:'#0c1611',card:'#14221a',sidebarBackground:'#101c16',subtleBackground:'#101c16',inputBackground:'#0e1913',line:'#2b4134',accent:'#72c99a',accentBackground:'#193526',hoverBackground:'#1a2d22',roomBackground:'#193526',buttonBackground:'#72c99a'}),
 warm:appearancePreset({background:'#faf6f0',accent:'#b45f32',accentBackground:'#f7e8dc',hoverBackground:'#fcf0e7',roomBackground:'#f7e8dc',buttonBackground:'#613a27',success:'#4a8d61',line:'#eadfd5'},{background:'#18110d',card:'#241a14',sidebarBackground:'#1e1611',subtleBackground:'#1e1611',inputBackground:'#1b130f',line:'#49352a',accent:'#e89a68',accentBackground:'#42291b',hoverBackground:'#35241a',roomBackground:'#42291b',buttonBackground:'#e89a68'}),
 graphite:appearancePreset({background:'#f1f3f5',accent:'#596579',accentBackground:'#e7ebf0',hoverBackground:'#eceff3',roomBackground:'#e7ebf0',buttonBackground:'#303844',line:'#dce1e6',success:'#368a68'},{background:'#0f1216',card:'#181d23',sidebarBackground:'#14191f',subtleBackground:'#14191f',inputBackground:'#11161b',line:'#303943',accent:'#9ca9bb',accentBackground:'#252d37',hoverBackground:'#202730',roomBackground:'#252d37',buttonBackground:'#9ca9bb'}),
 custom:appearancePreset()
};
let appearanceDraft=null,appearancePreviewData=null;
...
function updateThemeToggle(theme){const dark=theme==='dark';if(!themeToggleElement||!themeToggleIconElement||!themeToggleTextElement)return;themeToggleElement.setAttribute('aria-pressed',String(dark));themeToggleElement.setAttribute('aria-label',appTranslate(dark?'Helles Theme aktivieren':'Dunkles Theme aktivieren'));themeToggleElement.title=appTranslate(dark?'Zum hellen Theme wechseln':'Zum dunklen Theme wechseln');themeToggleIconElement.className=`mdi ${dark?'mdi-weather-sunny':'mdi-weather-night'}`;themeToggleTextElement.textContent=appTranslate(dark?'Helles Theme':'Dunkles Theme')}
function applyTheme(value,{persist=false,announce=false}={}){const theme=normalizeTheme(value);document.documentElement.dataset.theme=theme;document.documentElement.style.colorScheme=theme;applyAppearancePalette(theme);if(persist)writeThemeCookie(theme);updateThemeToggle(theme);if(announce)notify(appTranslate(theme==='dark'?'Dunkles Theme aktiviert.':'Helles Theme aktiviert.'))}
...
const pages=['overview','shelly','zigbee','hue','openccu','virtual','presence','automations','rooms','logs','settings'];
...
const overviewFavoritesSectionElement=document.getElementById('overviewFavoritesSection');
const overviewFavoritesGridElement=document.getElementById('overviewFavoritesGrid');
...
const formatEnergyKwh=value=>`${appI18n?.formatNumber?.(Math.round((value/1000)*1000)/1000,{maximumFractionDigits:3})??Math.round((value/1000)*1000)/1000} kWh`;
const fmt=(k,v)=>{if((k==='sunrise'||k==='sunset')&&typeof v==='string')return daylightTimeLabel(v);if(k==='daylightStatus'&&typeof v==='number')return appTranslate(daylightPhaseLabels[v]||String(v));if(typeof v==='boolean'){const states={motion:['Bewegung','Keine Bewegung'],open:['Offen','Geschlossen'],water:['Alarm','Trocken'],fire:['Alarm','Normal'],carbonMonoxide:['Alarm','Normal'],alarm:['Alarm','Normal'],vibration:['Erkannt','Ruhe'],lowBattery:['Niedrig','OK'],tampered:['Erkannt','OK'],dark:['Ja','Nein'],daylight:['Ja','Nein'],present:['Anwesend','Abwesend'],anyHome:['Jemand zuhause','Niemand zuhause'],nobodyHome:['Niemand zuhause','Jemand zuhause']};return appTranslate(states[k]?(v?states[k][0]:states[k][1]):v?'Ein':'Aus')}if((k==='controlMode'||k==='mode')&&typeof v==='string'){const modes={off:'Aus',manual:'Hand',auto:'Automatik',boost:'Boost',party:'Party',away:'Abwesend'};return appTranslate(modes[v.toLowerCase()]||v)}if(typeof v!=='number')return String(v);if(k==='energy')return formatEnergyKwh(v);if(k==='colorTemperatureKelvin')return `${appI18n?.formatNumber?.(Math.round(v))??Math.round(v)} K`;const value=Math.round(v*10)/10;const lower=k.toLowerCase();const unit=lower.includes('temperature')?' °C':k==='humidity'||lower.includes('position')||k==='brightness'||k==='battery'?' %':lower.includes('power')?' W':k==='consumption'?' Wh':k==='voltage'?' V':k==='current'?' A':k==='frequency'?' Hz':k==='lux'?' lx':k==='pressure'?' hPa':'';const formatted=appI18n?.formatNumber?.(value,{maximumFractionDigits:1})??String(value);return `${formatted}${unit}`};
const displayedState=d=>{const technicalHueKeys=new Set(['colorX','colorY','colorHex',...(d.state?.colorTemperatureKelvin!==undefined?['colorTemperature']:[])]);const values=Object.entries(d.state||{}).filter(([key,value])=>!technicalHueKeys.has(key)&&value!==null&&value!==undefined&&!(typeof value==='number'&&!Number.isFinite(value)));const limit=String(d.profile||'').split(' + ').includes('Daylight')?5:4;return values.slice(0,limit)};
...
function renderClimateMode(){
  ...
  const applied=climateModeData.lastAppliedAt?new Date(climateModeData.lastAppliedAt).toLocaleString(appLocale(),{dateStyle:'short',timeStyle:'short'}):'noch nicht angewendet';
...
function appearanceColorInputId(mode,key,kind){return `appearance-${mode}-${key}-${kind}`}
function renderAppearanceColorGrid(mode,palette){
  const container=mode==='dark'?appearanceDarkColors:appearanceLightColors;
  container.innerHTML=APPEARANCE_COLOR_FIELDS.map(([key,label])=>{const value=normalizeHexColor(palette[key],APPEARANCE_STANDARD[mode][key]);const colorId=appearanceColorInputId(mode,key,'color');const textId=appearanceColorInputId(mode,key,'text');return `<label class="appearance-color-field" title="${escapeHtml(label)}"><input id="${colorId}" type="color" value="${value}" data-appearance-mode="${mode}" data-appearance-key="${key}" aria-label="${escapeHtml(label)} auswählen"><span>${escapeHtml(label)}</span><input id="${textId}" type="text" inputmode="text" maxlength="7" value="${value.toUpperCase()}" data-appearance-mode="${mode}" data-appearance-key="${key}" aria-label="${escapeHtml(label)} als Hex-Wert"></label>`}).join('');
}
function renderAppearanceSettings(){
  const normalized=normalizeAppearanceSettings(appearanceData||{profile:'standard'});
  appearanceDraft={profile:normalized.profile,light:{...normalized.light},dark:{...normalized.dark}};
  appearancePreviewData=null;
  appearanceProfile.value=appearanceDraft.profile;
...
function setAppearanceDraftColor(mode,key,value){
  ...
  appearanceDraft[mode][key]=normalized;appearanceDraft.profile='custom';appearanceProfile.value='custom';
  const color=document.getElementById(appearanceColorInputId(mode,key,'color'));const text=document.getElementById(appearanceColorInputId(mode,key,'text'));
...
async function saveAppearanceSettings(){
  const payload=normalizeAppearanceSettings(appearanceDraft||appearanceData||{profile:'standard'});
  appearanceData=normalizeAppearanceSettings(await api('/api/settings/appearance',{method:'PUT',headers:{'content-type':'application/json'},body:JSON.stringify(payload)}));appearancePreviewData=null;renderAppearanceSettings();applyTheme(document.documentElement.dataset.theme);notify('Darstellung wurde gespeichert.');
}
...
function renderNotificationSettings(){
  ...
  const last=notificationData.lastSentAt?`Letzte Batteriewarnung ${new Date(notificationData.lastSentAt).toLocaleString(appLocale())}`:'Noch keine Batteriewarnung gesendet';
  const next=notificationData.nextEligibleAt?` · frühestens wieder ${new Date(notificationData.nextEligibleAt).toLocaleString(appLocale())}`:'';
...
function recoveryBackupSummary(backup){
  ...
  const date=created&&!Number.isNaN(created.getTime())?created.toLocaleString(appLocale()):'unbekannt';
...
function presenceNamesFromHouse(house,key='presentNames'){if(!house)return [];const raw=house.state?.[key];if(typeof raw!=='string'||!raw)return [];try{const parsed=JSON.parse(raw);return Array.isArray(parsed)?parsed.map(value=>String(value).trim()).filter(Boolean):[]}catch{return []}}
function compactPresenceNames(names,limit=3){const unique=[...new Set((names||[]).map(value=>String(value).trim()).filter(Boolean))];if(unique.length<=limit)return unique.join(', ');return `${unique.slice(0,limit).join(', ')} +${unique.length-limit}`}
function updateDashboardSummary(){
  ...
  const presentNames=presenceNamesFromHouse(housePresence);
  ...
  presenceDetail.textContent=presentNames.length?compactPresenceNames(presentNames):members?'niemand anwesend':'keine Personen konfiguriert';
  presenceCard.title=members?`${count} von ${members} ${members===1?'Person':'Personen'} anwesend${presentNames.length?` · ${presentNames.join(', ')}`:''}`:'Noch keine Person für die Präsenzerkennung konfiguriert';
}
async function load(){
  try{
    [all,rooms,phosconSettingsStatus,hueSettingsStatus,openCcuSettingsStatus]=await Promise.all([api('/api/devices'),api('/api/rooms'),api('/api/settings/phoscon'),api('/api/settings/hue').catch(()=>({baseUrl:'',applicationKeyConfigured:false,gateway:{connected:false}})),api('/api/settings/openccu')]);
    renderFilters();
    renderDevices();
    renderRooms();
...
async function refreshLiveData(){
  ...
  try{
    ...
    if(!activeCoverSliderId&&!activeBrightnessSliderId&&!activeTemperatureSliderId&&!activeHueColorTemperatureId&&!activeHueColorId)renderDevices();
    updateDashboardSummary();
...
function fillRoomFilter(select){const current=select.value;select.innerHTML='<option value="">Alle Räume</option>'+rooms.map(r=>`<option value="${r.id}" data-i18n-skip>${escapeHtml(r.name)}</option>`).join('')+'<option value="unassigned">Nicht zugeordnet</option>';select.value=current;}
function renderFilters(){fillRoomFilter(roomFilter);fillRoomFilter(zigbeeRoomFilter);fillRoomFilter(hueRoomFilter);fillRoomFilter(openCcuRoomFilter);fillRoomFilter(virtualRoomFilter)}
...
function hueColorTemperatureRange(d){const minMirek=Number(d.adapterData?.colorTemperatureMinMirek);const maxMirek=Number(d.adapterData?.colorTemperatureMaxMirek);const warm=Number.isFinite(maxMirek)&&maxMirek>0?Math.round(1000000/maxMirek):2000;const cool=Number.isFinite(minMirek)&&minMirek>0?Math.round(1000000/minMirek):6500;return {min:Math.min(warm,cool),max:Math.max(warm,cool)}}
function hueColorTemperatureControl(d,instance=''){if(d.source!=='hue'||!d.capabilities.includes('setColorTemperature'))return '';const range=hueColorTemperatureRange(d);const current=Number(d.state?.colorTemperatureKelvin);const value=Number.isFinite(current)?Math.min(range.max,Math.max(range.min,Math.round(current))):Math.round((range.min+range.max)/2);const id=`hue-color-temperature-${d.id}${instance?`-${instance}`:''}`;return `<div class="temperature-control hue-color-temperature-control"><div class="temperature-control-head"><label for="${id}">Farbtemperatur</label><output for="${id}">${value} K</output></div><input id="${id}" type="range" min="${range.min}" max="${range.max}" step="50" value="${value}" onpointerdown="activeHueColorTemperatureId='${d.id}'" onpointerup="activeHueColorTemperatureId=null" onblur="activeHueColorTemperatureId=null" oninput="previewHueColorTemperature('${d.id}',this.value,this)" onchange="setHueColorTemperature('${d.id}',this.value)" aria-label="Farbtemperatur von ${escapeHtml(d.name)}"></div>`}
function previewHueColorTemperature(id,value,input){activeHueColorTemperatureId=id;const output=input?.closest('.hue-color-temperature-control')?.querySelector('output');if(output)output.textContent=`${Math.round(Number(value)||0)} K`}
async function setHueColorTemperature(id,value){activeHueColorTemperatureId=id;try{await cmd(id,'setColorTemperature',Math.round(Number(value)||0))}finally{activeHueColorTemperatureId=null}}
function hueColorControl(d,instance=''){if(d.source!=='hue'||!d.capabilities.includes('setColor'))return '';const value=/^#[0-9a-f]{6}$/i.test(String(d.state?.colorHex||''))?String(d.state.colorHex):'#ffffff';const id=`hue-color-${d.id}${instance?`-${instance}`:''}`;return `<div class="hue-color-control"><label for="${id}">Farbe</label><input id="${id}" type="color" value="${value}" onfocus="activeHueColorId='${d.id}'" onblur="activeHueColorId=null" onchange="setHueColor('${d.id}',this.value)" aria-label="Farbe von ${escapeHtml(d.name)}"></div>`}
async function setHueColor(id,value){activeHueColorId=id;try{await cmd(id,'setColor',String(value))}finally{activeHueColorId=null}}
...
function deviceControls(d,instance=''){const controls=[brightnessControl(d,instance),hueColorTemperatureControl(d,instance),hueColorControl(d,instance),thermostatModeControl(d),targetTemperatureControl(d,instance),coverControl(d,instance)].filter(Boolean);return controls.length?`<div class="device-controls">${controls.join('')}</div>`:''}
function openCcuChannelMeta(d){if(d.source!=='openccu')return '';const channelName=String(d.adapterData?.channelName||'').trim();if(!channelName||channelName.toLocaleLowerCase()===String(d.name||'').trim().toLocaleLowerCase())return '';const channelIndex=String(d.adapterData?.channelAddress||'').split(':').at(-1);const generated=channelIndex&&channelName.toLocaleLowerCase().endsWith(`:${channelIndex}`.toLocaleLowerCase());return generated?'':` · ${escapeHtml(channelName)}`}
...
function overviewFavoriteDevices(){return all.filter(device=>Boolean(device.favorite)&&device.source!=='presence'&&device.source!=='system'&&!(device.source==='phoscon'&&device.hidden)).sort((a,b)=>String(a.room||'').localeCompare(String(b.room||''),appLocale(),{sensitivity:'base'})||String(a.name||'').localeCompare(String(b.name||''),appLocale(),{sensitivity:'base'}))}
function renderOverviewFavorites(){if(!overviewFavoritesSectionElement||!overviewFavoritesGridElement)return;const favorites=overviewFavoriteDevices();overviewFavoritesSectionElement.hidden=!favorites.length;overviewFavoritesGridElement.innerHTML=favorites.map(device=>deviceCard(device,false,'favorite')).join('')}
...
function renderDevices(){renderOverviewFavorites();renderOverviewDevices();renderDeviceGrid('shelly',deviceGrid,filter,roomFilter);renderDeviceGrid('phoscon',zigbeeGrid,zigbeeFilter,zigbeeRoomFilter);renderDeviceGrid('hue',hueGrid,hueFilter,hueRoomFilter);renderDeviceGrid('openccu',openCcuGrid,openCcuFilter,openCcuRoomFilter);renderDeviceGrid('virtual',virtualGrid,virtualFilter,virtualRoomFilter);renderHomeKitDeviceList()}
...
async function reconcileHue(){try{await api('/api/adapters/hue/reconcile',{method:'POST'});await load();notify('Hue-Synchronisierung abgeschlossen.')}catch(error){notify(friendlyHueError(error),true)}}
...
async function reconcile(){await Promise.allSettled([api('/api/adapters/shelly/reconcile',{method:'POST'}),api('/api/adapters/phoscon/reconcile',{method:'POST'}),api('/api/adapters/hue/reconcile',{method:'POST'}),api('/api/adapters/openccu/reconcile',{method:'POST'})]);await load();notify('Synchronisierung abgeschlossen.')}
...
function friendlyPhosconError(error){const rawCode=String(error?.code||'');const code=rawCode.split(':',1)[0];const messages={PHOSCON_URL_REQUIRED:'Trage die Adresse deiner deCONZ-Instanz ein.',PHOSCON_URL_INVALID:'Die deCONZ-Adresse ist ungültig. Beispiel: http://192.168.178.20:8080',PHOSCON_API_KEY_REQUIRED:'Trage einen API-Schlüssel ein oder fordere nach der Freigabe in deCONZ automatisch einen an.',PHOSCON_NOT_CONFIGURED:'Verbinde zuerst unter Einstellungen eine deCONZ-Instanz.',PHOSCON_GATEWAY_LOCKED:'Die App-Freigabe ist nicht aktiv. Öffne in deCONZ Einstellungen → Gateway → Erweitert und erlaube innerhalb von 60 Sekunden eine neue App.',PHOSCON_AUTHENTICATION_FAILED:'Der API-Schlüssel wurde von deCONZ abgelehnt.',PHOSCON_UNREACHABLE:'Die deCONZ-Instanz ist unter dieser Adresse nicht erreichbar.',PHOSCON_TIMEOUT:'Die deCONZ-Instanz antwortet nicht rechtzeitig.',ENCRYPTION_KEY_MISMATCH:'Der gespeicherte deCONZ-API-Schlüssel kann mit dem aktuellen SALTA_ENCRYPTION_KEY nicht entschlüsselt werden.',PHOSCON_REQUEST_FAILED:'Die Verbindung zu deCONZ konnte nicht hergestellt werden.'};if(rawCode.startsWith('PHOSCON_API_ERROR:'))return rawCode.slice('PHOSCON_API_ERROR:'.length);return messages[code]||error?.message||'Die deCONZ-Anfrage ist fehlgeschlagen.'}
function renderPhosconConnectionNotice(){if(!phosconSettingsStatus)return;const gateway=phosconSettingsStatus.gateway||{};if(gateway.connected){zigbeeConnectionNotice.hidden=true;zigbeeConnectionNotice.textContent='';return}zigbeeConnectionNotice.hidden=false;zigbeeConnectionNotice.textContent=phosconSettingsStatus.apiKeyConfigured?(gateway.lastError?`${appTranslate('deCONZ ist derzeit nicht erreichbar:')} ${appTranslate(friendlyPhosconError({code:gateway.lastError}))}`:appTranslate('deCONZ ist konfiguriert, aber derzeit nicht verbunden.')):appTranslate('Verbinde zuerst unter Einstellungen eine deCONZ-Instanz.')}
function renderPhosconGatewayStatus(settings){const gateway=settings?.gateway||{};const connected=Boolean(gateway.connected);phosconGatewayStatus.className=`gateway-status ${connected?'connected':'disconnected'}`;const realtime=gateway.realtimeConnected?'Realtime: WebSocket verbunden':gateway.realtimeFallbackPolling?'Realtime: Fallback-Abfrage aktiv':'Realtime: nicht verbunden';const details=connected?[gateway.deviceName||gateway.name,gateway.softwareVersion?`deCONZ ${gateway.softwareVersion}`:'',gateway.apiVersion?`API ${gateway.apiVersion}`:'',gateway.zigbeeChannel?`Zigbee-Kanal ${gateway.zigbeeChannel}`:'',realtime,gateway.realtimeLastEvent?`Letztes Tasterevent ${new Date(gateway.realtimeLastEvent).toLocaleTimeString(appLocale(),{hour:'2-digit',minute:'2-digit',second:'2-digit'})}`:''].filter(Boolean).join(' · '):(gateway.lastError?friendlyPhosconError({code:gateway.lastError}):'Keine aktive Verbindung.');phosconGatewayStatus.innerHTML=`<span class="gateway-status-dot" aria-hidden="true"></span><div><strong>${connected?'Verbunden':'Nicht verbunden'}</strong><small>${escapeHtml(details)}</small></div>`;phosconDisconnectButton.hidden=!settings?.apiKeyConfigured}
function deconzUiUrl(value){try{const url=new URL(String(value||'').trim());if(url.protocol!=='http:'&&url.protocol!=='https:')return undefined;url.hash='';return url.toString()}catch{return undefined}}
function updateDeconzUiLink(){const href=deconzUiUrl(phosconBaseUrl.value);deconzUiLink.hidden=!href;if(href)deconzUiLink.href=href;else deconzUiLink.removeAttribute('href')}
async function loadPhosconSettings(){const settings=await api('/api/settings/phoscon');phosconSettingsStatus=settings;phosconBaseUrl.value=settings.baseUrl||'';updateDeconzUiLink();phosconApiKey.value='';phosconApiKeyState.textContent=settings.apiKeyConfigured?(settings.encryptionStatus==='invalid'?'Der gespeicherte API-Schlüssel kann nicht entschlüsselt werden. Gib ihn neu ein oder kopple SALTA erneut.':'Ein API-Schlüssel ist verschlüsselt gespeichert. Leer lassen, um ihn beizubehalten.'):'Noch kein API-Schlüssel gespeichert.';phosconCredentialWarning.hidden=settings.encryptionStatus!=='invalid';phosconCredentialWarning.textContent=settings.encryptionStatus==='invalid'?'Der aktuelle SALTA_ENCRYPTION_KEY passt nicht zum gespeicherten deCONZ-API-Schlüssel. Kopple die Instanz erneut oder trage den Schlüssel neu ein.':'';renderPhosconGatewayStatus(settings);renderPhosconConnectionNotice();return settings}
async function savePhoscon(){try{const settings=await api('/api/settings/phoscon',{method:'PUT',headers:{'content-type':'application/json'},body:JSON.stringify({baseUrl:phosconBaseUrl.value.trim(),apiKey:phosconApiKey.value.trim()||undefined})});phosconSettingsStatus=settings;await load();await loadPhosconSettings();notify('deCONZ-Verbindung wurde gespeichert und geprüft.')}catch(error){notify(friendlyPhosconError(error),true)}}
async function pairPhoscon(){const baseUrl=phosconBaseUrl.value.trim();if(!baseUrl){phosconBaseUrl.focus();return}const original=phosconPairButton.textContent;phosconPairButton.disabled=true;phosconPairButton.textContent='Schlüssel wird angefordert …';try{const settings=await api('/api/settings/phoscon/pair',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({baseUrl})});phosconSettingsStatus=settings;await load();await loadPhosconSettings();notify('SALTA wurde mit deCONZ verbunden.')}catch(error){notify(friendlyPhosconError(error),true)}finally{phosconPairButton.disabled=false;phosconPairButton.textContent=original}}
async function disconnectPhoscon(){if(!confirm('deCONZ-Verbindung trennen? Die synchronisierten Zigbee-Geräte werden aus SALTA entfernt, aber nicht aus deCONZ gelöscht.'))return;await api('/api/settings/phoscon',{method:'DELETE'});phosconSettingsStatus=null;await load();await loadPhosconSettings();notify('deCONZ-Verbindung wurde getrennt.')}
function friendlyHueError(error){const messages={HUE_URL_REQUIRED:'Trage die lokale Adresse deiner Philips Hue Bridge ein.',HUE_URL_INVALID:'Die Hue-Bridge-Adresse ist ungültig. Beispiel: https://192.168.178.25',HUE_APPLICATION_KEY_REQUIRED:'Trage einen Application Key ein oder kopple SALTA über den Link-Button mit der Hue Bridge.',HUE_NOT_CONFIGURED:'Verbinde zuerst unter Einstellungen eine Philips Hue Bridge.',HUE_LINK_BUTTON_REQUIRED:'Drücke zuerst den runden Link-Button auf der Hue Bridge und starte die Kopplung danach erneut.',HUE_DISCOVERY_FAILED:'Die lokale Hue-Bridge-Suche per mDNS ist fehlgeschlagen. Trage die Bridge-Adresse manuell ein oder versuche es erneut.',HUE_AUTHENTICATION_FAILED:'Der gespeicherte Hue Application Key wurde von der Bridge abgelehnt.',HUE_LOCAL_NETWORK_REQUIRED:'Die Hue-Bridge-Adresse muss auf eine private oder link-lokale Adresse im lokalen Netzwerk zeigen.',HUE_TLS_CERTIFICATE:'Das TLS-Zertifikat der Hue Bridge konnte nicht gegen die Signify-Hue-Bridge-Zertifikate geprüft werden. Aktualisiere die Bridge-Firmware und versuche es erneut.',HUE_BRIDGE_ID_REQUIRED:'Die Identität der Hue Bridge konnte nicht sicher bestimmt werden.',HUE_BRIDGE_ID_MISMATCH:'Die Identität der Hue Bridge passt nicht zum TLS-Zertifikat.',HUE_UNREACHABLE:'Die Philips Hue Bridge ist unter dieser Adresse nicht erreichbar.',HUE_TIMEOUT:'Die Philips Hue Bridge antwortet nicht rechtzeitig.',HUE_INVALID_RESPONSE:'Die Philips Hue Bridge hat eine unerwartete API-Antwort geliefert.',HUE_PAIRING_FAILED:'Die Kopplung mit der Philips Hue Bridge ist fehlgeschlagen.',ENCRYPTION_KEY_MISMATCH:'Der gespeicherte Hue Application Key kann mit dem aktuellen SALTA_ENCRYPTION_KEY nicht entschlüsselt werden.'};return messages[error?.code]||error?.message||'Die Philips-Hue-Anfrage ist fehlgeschlagen.'}
function renderHueConnectionNotice(){if(!hueSettingsStatus)return;const gateway=hueSettingsStatus.gateway||{};if(gateway.connected){hueConnectionNotice.hidden=true;hueConnectionNotice.textContent='';return}hueConnectionNotice.hidden=false;hueConnectionNotice.textContent=hueSettingsStatus.applicationKeyConfigured?(gateway.lastError?`Hue Bridge ist derzeit nicht erreichbar: ${friendlyHueError({code:gateway.lastError})}`:'Hue ist konfiguriert, aber derzeit nicht verbunden.'):'Verbinde zuerst unter Einstellungen eine Philips Hue Bridge.'}
function renderHueGatewayStatus(settings){const gateway=settings?.gateway||{};const connected=Boolean(gateway.connected);hueGatewayStatus.className=`gateway-status ${connected?'connected':'disconnected'}`;const realtime=gateway.realtimeConnected?'Realtime: Eventstream verbunden':'Realtime: nicht verbunden';const details=connected?[gateway.name||'Hue Bridge',gateway.bridgeId?`Bridge ${gateway.bridgeId}`:'',gateway.softwareVersion?`Firmware ${gateway.softwareVersion}`:'',gateway.apiVersion?`API ${gateway.apiVersion}`:'',realtime,gateway.realtimeLastEvent?`Letztes Event ${new Date(gateway.realtimeLastEvent).toLocaleTimeString(appLocale(),{hour:'2-digit',minute:'2-digit',second:'2-digit'})}`:''].filter(Boolean).join(' · '):(gateway.lastError?friendlyHueError({code:gateway.lastError}):'Keine aktive Verbindung.');hueGatewayStatus.innerHTML=`<span class="gateway-status-dot" aria-hidden="true"></span><div><strong>${connected?'Verbunden':'Nicht verbunden'}</strong><small>${escapeHtml(details)}</small></div>`;hueDisconnectButton.hidden=!settings?.applicationKeyConfigured}
async function loadHueSettings(){const settings=await api('/api/settings/hue');hueSettingsStatus=settings;hueBaseUrl.value=settings.baseUrl||'';hueApplicationKey.value='';hueApplicationKeyState.textContent=settings.applicationKeyConfigured?(settings.encryptionStatus==='invalid'?'Der gespeicherte Application Key kann nicht entschlüsselt werden. Kopple SALTA erneut oder trage einen neuen Key ein.':'Ein Application Key ist verschlüsselt gespeichert. Leer lassen, um ihn beizubehalten.'):'Noch kein Application Key gespeichert.';hueCredentialWarning.hidden=settings.encryptionStatus!=='invalid';hueCredentialWarning.textContent=settings.encryptionStatus==='invalid'?'Der aktuelle SALTA_ENCRYPTION_KEY passt nicht zum gespeicherten Hue Application Key. Kopple SALTA erneut mit der Bridge.':'';renderHueGatewayStatus(settings);renderHueConnectionNotice();return settings}
async function saveHue(){try{const settings=await api('/api/settings/hue',{method:'PUT',headers:{'content-type':'application/json'},body:JSON.stringify({baseUrl:hueBaseUrl.value.trim(),applicationKey:hueApplicationKey.value.trim()||undefined})});hueSettingsStatus=settings;await load();await loadHueSettings();notify('Philips Hue wurde gespeichert und geprüft.')}catch(error){notify(friendlyHueError(error),true)}}
function useDiscoveredHue(baseUrl){hueBaseUrl.value=String(baseUrl||'');hueBaseUrl.focus();notify('Hue-Bridge-Adresse übernommen. Drücke jetzt den Link-Button der Bridge und starte die Kopplung.')}
async function discoverHue(){const original=hueDiscoverButton.textContent;hueDiscoverButton.disabled=true;hueDiscoverButton.textContent='Suche läuft …';hueDiscoveryResults.innerHTML='<p class="muted">SALTA sucht per mDNS im lokalen Netzwerk nach Philips Hue Bridges …</p>';try{const result=await api('/api/settings/hue/discover',{method:'POST'});const bridges=Array.isArray(result?.bridges)?result.bridges:[];if(!bridges.length){hueDiscoveryResults.innerHTML='<div class="empty-state compact"><strong>Keine Hue Bridge gefunden</strong><p class="muted">Du kannst die IP-Adresse oder den Hostnamen weiterhin manuell eintragen.</p></div>';return}hueDiscoveryResults.innerHTML=bridges.map(bridge=>{const baseUrl=String(bridge.baseUrl||'');const encoded=encodeURIComponent(baseUrl).replace(/'/g,'%27');const label=bridge.name||'Philips Hue Bridge';const meta=[bridge.address,bridge.bridgeId?`Bridge ${bridge.bridgeId}`:''].filter(Boolean).join(' · ');return `<div class="discovery-item"><div><strong>${escapeHtml(label)}</strong><small>${escapeHtml(meta)}</small></div><button type="button" onclick="useDiscoveredHue(decodeURIComponent('${encoded}'))">Übernehmen</button></div>`}).join('');if(bridges.length===1){hueBaseUrl.value=bridges[0].baseUrl||'';notify('Eine Philips Hue Bridge wurde gefunden und übernommen.')}}catch(error){hueDiscoveryResults.innerHTML='';notify(friendlyHueError(error),true)}finally{hueDiscoverButton.disabled=false;hueDiscoverButton.textContent=original}}
async function pairHue(){const baseUrl=hueBaseUrl.value.trim();if(!baseUrl){hueBaseUrl.focus();return}const original=huePairButton.textContent;huePairButton.disabled=true;huePairButton.textContent='Bridge wird gekoppelt …';try{const settings=await api('/api/settings/hue/pair',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify({baseUrl})});hueSettingsStatus=settings;await load();await loadHueSettings();notify('SALTA wurde mit der Philips Hue Bridge gekoppelt.')}catch(error){notify(friendlyHueError(error),true)}finally{huePairButton.disabled=false;huePairButton.textContent=original}}
async function disconnectHue(){if(!confirm('Philips-Hue-Verbindung trennen? Die Hue-Geräte werden aus SALTA entfernt, bleiben aber vollständig auf der Hue Bridge erhalten.'))return;await api('/api/settings/hue',{method:'DELETE'});hueSettingsStatus=null;await load();await loadHueSettings();notify('Philips-Hue-Verbindung wurde getrennt.')}
...
async function showSettingsPanel(panel){const target=['general','appearance','shelly','phoscon','hue','openccu','homekit','climate','notifications','backup'].includes(panel)?panel:'general';document.querySelectorAll('[data-settings-content]').forEach(content=>content.hidden=content.dataset.settingsContent!==target);document.querySelectorAll('[data-settings-panel]').forEach(button=>{const active=button.dataset.settingsPanel===target;button.classList.toggle('active',active);if(active)button.setAttribute('aria-current','page');else button.removeAttribute('aria-current')});if(target==='general')await loadGeneralSettings();else if(target==='appearance'){if(!appearanceData)await loadAppearanceSettings();renderAppearanceSettings()}else if(target==='phoscon')await loadPhosconSettings();else if(target==='hue')await loadHueSettings();else if(target==='openccu')await loadOpenCcuSettings();else if(target==='homekit')await loadHomeKitSettings();else if(target==='climate')await loadClimateSettings();else if(target==='notifications')await loadNotificationSettings();else if(target==='shelly')await loadShellySettings()}
function openAddVirtualDevice(){addVirtualDeviceForm.reset();virtualDeviceType.value='button';virtualDeviceRoom.innerHTML='<option value="">Nicht zugeordnet</option>'+rooms.map(r=>`<option value="${r.id}" data-i18n-skip>${escapeHtml(r.name)}</option>`).join('');addVirtualDeviceDialog.showModal();virtualDeviceName.focus()}
...
function deviceInfoTimestamp(value){if(!value)return '–';const date=new Date(value);return Number.isNaN(date.getTime())?'–':date.toLocaleString(appLocale(),{dateStyle:'short',timeStyle:'short'})}
...
if(d.source==='hue'){add('Hue-Ressource',adapter.hueResourceId||d.sourceId,{copy:true});add('Hue-Gerät',adapter.hueOwnerDeviceId,{copy:true});add('Hue-Archetyp',adapter.hueArchetype)}
...
function openDevice(id){
  ...
  const shelly=selectedDevice.source==='shelly';const zigbee=selectedDevice.source==='phoscon';const hue=selectedDevice.source==='hue';const openccu=selectedDevice.source==='openccu';const virtual=selectedDevice.source==='virtual';
  deviceDialogTitle.textContent=selectedDevice.name;
  deviceDialogDescription.textContent=shelly?'Shelly-Gerät konfigurieren und technische Geräteinformationen prüfen.':zigbee?'Zigbee-Gerät konfigurieren und Phoscon-Geräteinformationen prüfen.':hue?'Philips-Hue-Gerät konfigurieren und Bridge-Ressourcen prüfen.':openccu?'HomeMatic-Gerät konfigurieren und OpenCCU-Geräteinformationen prüfen.':'Virtuelles SALTA-Gerät konfigurieren und technische Informationen prüfen.';
  ...
  deviceName.value=selectedDevice.name;
   deviceFavorite.checked=Boolean(selectedDevice.favorite);
  const roomOptions='<option value="">Nicht zugeordnet</option>'+rooms.map(r=>`<option value="${r.id}" data-i18n-skip>${escapeHtml(r.name)}</option>`).join('');
...
async function saveDeviceConfig(){
  ...
  const config={name,roomId:deviceRoom.value||null,favorite:deviceFavorite.checked,presentationType,...(selectedDevice.source==='virtual'?{virtualType:deviceVirtualType.value==='button'?'button':'switch'}:{}),homekitEnabled:homekitSupported&&deviceHomeKitEnabled.checked,homekitName:deviceHomeKitName.value.trim()||null,homekitUseSaltaRoom:useSaltaRoom,homekitRoomId:useSaltaRoom?null:(deviceHomeKitRoom.value||null)};
...
async function openAddShelly(){
  shellyRoom.innerHTML='<option value="">Nicht zugeordnet</option>'+rooms.map(r=>`<option value="${r.id}" data-i18n-skip>${escapeHtml(r.name)}</option>`).join('');
  addShellyForm.reset();
...
function systemLogSourceLabel(source){const names={system:'System',openccu:'OpenCCU',hue:'Philips Hue',virtual:'Virtuell',presence:'Präsenz',automation:'Automationen',notification:'Benachrichtigungen',homekit:'HomeKit'};return names[source]||source}
function systemLogTime(value){const date=new Date(value);return Number.isNaN(date.getTime())?'–':date.toLocaleString(appLocale(),{dateStyle:'short',timeStyle:'medium'})}
...
phosconBaseUrl.addEventListener('input',updateDeconzUiLink);
phosconForm.addEventListener('submit',event=>{event.preventDefault();savePhoscon().catch(e=>notify(friendlyPhosconError(e),true))});
hueForm.addEventListener('submit',event=>{event.preventDefault();saveHue().catch(e=>notify(friendlyHueError(e),true))});
...
appearanceSettingsForm.addEventListener('change',event=>{const input=event.target;if(!(input instanceof HTMLInputElement)||!input.dataset.appearanceMode||!input.dataset.appearanceKey)return;setAppearanceDraftColor(input.dataset.appearanceMode,input.dataset.appearanceKey,input.value)});
...
document.addEventListener('salta:languagechange',refreshLocalizedApplication);
...
async function initializeApplication(){
  await appI18n?.init?.().catch(()=>undefined);
  appI18n?.bindSelector?.(document.getElementById('languageSelector'));
  appI18n?.bindSelector?.(document.getElementById('appearanceLanguage'));
  await initializeSession();
  await loadAppearanceSettings().catch(()=>undefined);
  navigate();load();setInterval(refreshLiveData,5000);
}
initializeApplication().catch(()=>undefined);
