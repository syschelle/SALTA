...
const icons={outlet:'mdi-power-socket-eu',switch:'mdi-toggle-switch-outline',energyMeter:'mdi-flash-outline',windowCovering:'mdi-window-shutter',light:'mdi-lightbulb-outline',fan:'mdi-fan'};
...
const typeLabels={outlet:'Steckdose',switch:'Schalter',energyMeter:'Energiezähler',windowCovering:'Rollladen',light:'Licht',fan:'Ventilator'};
...
const labels={on:'Status',brightness:'Helligkeit',power:'Leistung',energy:'Energie',voltage:'Spannung',current:'Strom',frequency:'Frequenz',temperature:'Temperatur',battery:'Batterie',currentPosition:'Position',targetPosition:'Ziel',positionState:'Fahrt',mode:'Modus',totalPower:'Gesamtleistung',powerL1:'Phase L1',powerL2:'Phase L2',powerL3:'Phase L3'};
